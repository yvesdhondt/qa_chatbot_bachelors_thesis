...
def add_answered(connection, question, answer):
    ...
    :param answer: the answer to the question, this shouldn't be None (use add_unanswered instead if that is the case)
    :return: the row id of the inserted question-answer pair
    """
    insert = """ INSERT INTO forum(question,answer)
                 VALUES(?,?) """
    cursor = connection.cursor()
...
if __name__ == '__main__':
    ...
    faq_forum = get_connection(r"C:\sqlite\db\faq_forum_alt.db")
